        ...
        <table id="modifyE">
            ...
            <c:forEach var="point" items="${list}">
                <tr>
                    ...
                    <td id="name${point.getId()}">${point.getName()}</td>
                    <td id="surname${point.getId()}">${point.getSurname()}</td>
                    <td id="email${point.getId()}">${point.getEmail()}</td>
                    <td id="login${point.getId()}">${point.getLogin()}</td>
                    <td id="blackList${point.getId()}">${point.getBlackList()}</td>
                    <td>
                        <div class="modifyB" onclick="modifyUser(${point.getId()});">Редактировать</div>
                    </td>
                </tr>
            </c:forEach>
        </table>
