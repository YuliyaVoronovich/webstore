        ...
        <div id="content_descriptionF">
            ...
            <div class="slider slider1">
                <div class="sliderContent">
                    <div class="item">
                        <img class="imgD" src="img/washer/${list.get(5)}-1.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${list.get(5)}-2.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${list.get(5)}-3.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${list.get(5)}-4.jpg" alt=""/>
                    </div>
                </div>
            </div>
        </div>
