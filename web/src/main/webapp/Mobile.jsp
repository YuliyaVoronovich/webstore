        ...
        <div id="department">
            <div id="insideDepartment">
                <c:forEach var="good" items="${mobile}">
                    <div class="element">
                        <div class="picture1">
                            <img class="picture" src="img/mobile/${good.getImg()}.jpg"/>
                        </div>
                        <div class="des1">
                            <div class="brand">${good.getBrand()} ${good.getModel()}</div>
                            <div class="des2">
                                Доставка:
                                Самовывоз, По городу - Бесплатно. А также Экспресс-доставка по Минску в течение 3 часов! Подробнее на сайте., По области - Выберите свой населенный пункт и рассчитайте стоимость доставки на сайте, По Беларуси - Выберите свой населенный пункт и рассчитайте стоимость доставки на сайте
                                Оплата:
                                Наличный расчет, Банковская карта, Система «Расчет» (ЕРИП), Почтовый перевод
                            </div>
                            <div class="descriptionGood"><a class="a1" href="do?command=DescriptionMobile&id=${good.getId()}" target="_blank">Перейти к
                                описанию...</a></div>
                        </div>
                        <div class="order">
