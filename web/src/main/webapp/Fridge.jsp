        ...
        <div id="department">
            <div id="insideDepartment">
                <c:forEach var="good" items="${fridge}">
                        <div class="element">
                            <div class="picture1">
                                <img class="picture" src="img/fridge/${good.getImg()}.jpg"/>
                            </div>
                            <div class="des1">
                                ...
                                <div class="descriptionGood"><a class="a1" href="do?command=DescriptionFridge&id=${good.getId()}" target="_blank">Перейти к
                                    описанию...</a></div>
                            </div>
                            <div class="order">
