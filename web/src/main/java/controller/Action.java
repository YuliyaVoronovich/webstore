...
enum Action {
    ...
    DESCRIPTIONTV("/descriptionTv.jsp", "/descriptionTv.jsp", new CommandDescriptionTv()),
    DESCRIPTIONFRIDGE("/descriptionFridge.jsp", "/descriptionFridge.jsp", new CommandDescriptionFridge()),
    DESCRIPTIONWASHER("/descriptionWasher.jsp", "/descriptionWasher.jsp", new CommandDescriptionWasher()),
    DESCRIPTIONMOBILE("/descriptionMobile.jsp", "/descriptionMobile.jsp", new CommandDescriptionMobile());
